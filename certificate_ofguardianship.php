                ...
                <div class="card">
                  <div class="card-header">
                    <div class="card-head-row">
                      <div class="card-title">Guardian Certificate Issuance</div>
																...
																<tr>
																	...
																	<td>
																		...
																		if (isset($data['guardian_name'])) {
																				echo ucwords($data['guardian_name']);
																		} else {
																				echo "N/A";
																		}
																		?>
																		...
																		<td>
																			<div class="form-button-action">
																				<a type="button" data-toggle="tooltip"
																					href="generate_guardian_cert.php?cr_id=<?= $row['id'] ?>"
																					class="btn btn-link btn-primary" data-original-title="Generate Permit">
																					<i class="fas fa-file-alt"></i>
																				</a>
																				<?php if (isset($_SESSION['username']) && $_SESSION['role'] == 'administrator') : ?>
																					<a type="button" data-toggle="tooltip"
																						href="model/remove_guardian.php?id=<?= $row['id'] ?>"
