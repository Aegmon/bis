                            ...
                            <td>
                              <div class="row">
                                <div class="col-2 d-flex justify-content-center align-items-center">
                                  <img src="<?= imgSrc($row["avatar"], "img/person.png") ?>" alt="..."
                            ...
                            <td>
                              <div class="form-button-action">
                                ...
                                <a type="button" data-toggle="tooltip" href="generate_fpscert.php?id=<?= $row["id"] ?>"
                                  class="btn btn-link btn-info" data-original-title="Generate">
                                  <i class="fa fa-file"></i>
                                </a>
                                <a type="button" data-toggle="tooltip"
                                  href="model/residents.php?id=<?= $row["id"] ?>&unset-4ps=1"
                                  onclick="confirm('Are you sure you want to delete this resident?');"
                ...
                <form method="POST" action="model/edit_resident.php" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" placeholder="Enter Birthdate" name="bdate"
                              id="bdate" required>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label>Address</label>
                        <textarea class="form-control" required name="address" placeholder="Enter Address"
                          id="address"></textarea>
                      </div>
